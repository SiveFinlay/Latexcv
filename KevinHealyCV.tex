...
\par{\fontsize{10.5}{10}\selectfont Project showing that the distribution of intestinal parasite body sizes follows a distribution predicted from the fractal structure of the mouse intestine. (Overall mark of 82\%).\bigskip}
...
& our evolution research to the general public. Estimated attendance of 200.\\
\textbullet & I regularly produce research videos and images aimed at both the scientific and\\
& the general public.\\
\textbullet & Regular contributor of articles to the EcoEvo@TCD blog - http://www.ecoevoblog.com/\\
...
\begin{tabular}{ll}
%---------------------------------------
\textit{Teaching and Tutorials}:&I have run several external R and statistical help workshops and classes\\ 
& as part of a research comprehension course for Senior Sophister Zoologists.\\

\end{tabular}


\begin{tabular}{ll}
\textit{Field Course Assistant}:& Field course assistant for a week-long intensive terrestrial course for\\ 
&  Junior Sophisters, teaching field skills in small mammal trapping, insect and\\
